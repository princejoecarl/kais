...
@section('content_header')
    ...
    <br>
    <form method="GET" action="{{route('skills.create')}}">
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    <h3 class="profile-username text-center"><a class="text-bold" href="{{route('skill.detail', compact('skill'))}}">{{$skill->name}}</a></h3>
